...
const CheckInLot = () => {
    ...
    const handleConfirmButtonPress = async () => {
        try {
            ...
            console.error("Error updating lots availability", error);
            alert("Error updating lots availability: ", error);
        }
    };
