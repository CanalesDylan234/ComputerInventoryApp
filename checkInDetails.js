...
const CheckInDetailsPage = () => {
    ...
    const handleConfirmation = () => {
        ...
        const checkOutCollection = db.collection('checkInEmail');
    ...
    const sendEmail = () => {
        ...
        const templateParams = {
            ...
            from_email: email,
            to_email: email,
            message: 'Thank you for Checking-In each Computer(s)/Lot(s)!.' + `\n\nScanned Computers: \n${barcodeList}`,
        ...
        emailjs.send(serviceId, templateId, templateParams, publicKey)
            .then((response) => {
                ...
                navigation.navigate('checkInConfirm'); // Navigate to email confirmation page
            })
            .catch((error) => {
        ...
        <View style={styles.container}>
            <View>
                <Text>
                    ...
                    your check-in information with the admin!
                </Text>
            </View>
            <TextInput
                style={styles.input}
